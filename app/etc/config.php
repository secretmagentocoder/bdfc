...
return [
    'modules' => [
        ...
        'Amazon_Payment' => 1,
        'BENEFIT_BBiPay' => 1,
        'Ecommage_CheckoutData' => 1,
        'Bss_MinMaxQtyOrderPerCate' => 1,
        'Bss_Simpledetailconfigurable' => 1,
        'Custom_Api' => 1,
        'Custom_CartRule' => 1,
        'Custom_ConfigurableDynamic' => 0,
        'Custom_GuestRegistration' => 1,
        'Custom_Orderemaildata' => 1,
        'Custom_ProductFeedExport' => 1,
        'Custom_Recently' => 1,
        'Custom_Shortby' => 1,
        'Custom_Websiteswitcher' => 1,
        ...
        'Ecommage_NavSyncPromotion' => 1,
        'Ecommage_CheckoutCart' => 1,
        'Bodak_CheckoutCustomForm' => 1,
        'Ecommage_CheckoutForm' => 1,
        'Ecommage_CreateProductApi' => 1,
        'Ecommage_CustomerCategory' => 1,
        'Ecommage_CustomerCheckoutSuccess' => 1,
        'Ecommage_CustomerOrderHistory' => 1,
        'Ecommage_CustomerPersonalDetail' => 1,
        'Ecommage_CustomerUpdatePassword' => 1,
        'Ecommage_CustomerWishList' => 1,
        'Ecommage_FixSimpledetailconfigurable' => 1,
        'Ecommage_ChangeDeliveryDate' => 1,
        'Ecommage_OrderRaffle' => 1,
        'Ecommage_RaffleTickets' => 1,
        'Ecommage_SalesRule' => 1,
        'Ecommage_TimeRaffle' => 1,
        'ExperiencesDigital_CreateUpdateProductAPI' => 1,
        'ExperiencesDigital_CustomCalculation' => 1,
        'ExperiencesDigital_CustomCategoryAttribute' => 1,
        'ExperiencesDigital_Flights' => 1,
        'Fastly_Cdn' => 1,
        'Flamingo_Badgefield' => 1,
        'Flamingo_Categoryfield' => 1,
        'Flamingo_Checkout' => 1,
        'Flamingo_Enddatefield' => 1,
        'Flamingo_Startdatefield' => 1,
        'Klarna_Core' => 1,
        ...
        'Plumrocket_Base' => 1,
        'Plumrocket_CartReservation' => 1,
        'Rootways_Megamenu' => 1,
        'Sparsh_AjaxInfiniteScroll' => 1,
        ...
        'Vertex_TaxStaging' => 1,
        'Webkul_SpecialPromotions' => 0,
        'Webkuls_SpecialPromotions' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
