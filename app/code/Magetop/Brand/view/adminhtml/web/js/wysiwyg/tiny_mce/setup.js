...
define([
    ...
    'Magetop_Brand/js/magetopbrowser'
], function(jQuery, _, tinyMCE) {

    magetopTinyMceWysiwygSetup = Class.create();

    magetopTinyMceWysiwygSetup.prototype = {
        ...
        // retrieve directimagetop URL with substituted directive value
        makeDirectiveUrl: function(directive) {
            return this.config.directimagetop_url.replace('directive', 'directive/___directive/' + directive);
        },

        encodeDirectimagetop: function(content) {
            // collect all HTML tags with attributes that contain directimagetop
        ...
        decodeDirectimagetop: function(content) {
            // escape special chars in directimagetop url to use it in regular expression
        ...
        beforeSetContent: function(o){
            if (this.config.add_widgets) {
                ...
                o.content = this.encodeDirectimagetop(o.content);
            } else if (this.config.add_directimagetop) {
                o.content = this.encodeDirectimagetop(o.content);
            }
        },
        ...
        saveContent: function(o) {
            if (this.config.add_widgets) {
                ...
                o.content = this.decodeDirectimagetop(o.content);
            } else if (this.config.add_directimagetop) {
                o.content = this.decodeDirectimagetop(o.content);
            }
            if(o.content!=''){
