...
use Magetop\Brand\Block\Adminhtml\Group\Grid\Renderer\Action\UrlBuilder;
use Magento\Framework\UrlInterface;

class GroupActions extends Column
{
	/** Url Path */
	const GROUP_URL_PATH_EDIT = 'magetopbrand/group/edit';
	const GROUP_URL_PATH_DELETE = 'magetopbrand/group/delete';
