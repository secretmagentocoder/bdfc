 ...
 */
namespace Magetop\Brand\Block\Adminhtml\Brand;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct(){
    	...
    	if($this->_isAllowedAction('Magetop_Brand::brand_save')){
    	...
    	if ($this->_isAllowedAction('Magetop_Brand::brand_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('magetop_brand')->getId()) {
            return __("Edit Brand '%1'", $this->escapeHtml($this->_coreRegistry->registry('magetop_brand')->getName()));
        } else {
            return __('New Brand');
        }
    }
