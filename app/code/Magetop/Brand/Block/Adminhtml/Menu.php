 ...
 * @copyright  Copyright (c) 2016 Magetop (https://www.magetop.com/)
 * @license    https://www.magetop.com/LICENSE.txt
 */

namespace Magetop\Brand\Block\Adminhtml;

use Magetop\Brand\Model\Config;
...
class Menu extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Magetop_Brand::menu.phtml';
        ...
        if ($this->items === null) {
            $items = [
                      'brand' => [
                            ...
                            'resource' => 'Magetop_Brand::brand',
                            'child' => [
                                'brand/new/' => [
                                    'title' => __('New Brand'),
                                    'url' => $this->getUrl('*/brand/new/'),
                                    'resource' => 'Magetop_Brand::brand_edit',
                                ]
                            ]
                        ],
                        'group' => [
                            ...
                            'resource' => 'Magetop_Brand::group',
                            'child' => [
                                'group/new' => [
                                    'title' => __('New Group'),
                                    'url' => $this->getUrl('*/group/new'),
                                    'resource' => 'Magetop_Brand::group_edit',
                                ]
                            ]
                        ],
                        'import' => [
                                     ...
                                     'resource' => 'Magetop_Brand::import',
                                    ],
                      'settings' => [
                                     'title'    => __('Settings'),
                                     'url'      => $this->getUrl('adminhtml/system_config/edit/section/magetopbrand'),
                                     'resource' => 'Magetop_Brand::config_brand',
                                    ],
                      'support'  => [
                                     'title' => __('Get Support'),
                                     'url'   => Config::MAGETOP_TICKET,
                                     'attr'  => ['target' => '_blank'],
                                     'separator' => true,
                                    ],
                     ];
