 ...
 * @copyright  Copyright (c) 2017 Magetop (https://www.magetop.com/)
 * @license    https://www.magetop.com/LICENSE.txt
 */
namespace Magetop\Brand\Block\Adminhtml\Import\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
         ...
         */
        if($this->_isAllowedAction('Magetop_Brand::import')){
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Magetop Brand Import')]);
