...
use Magetop\Brand\Model\Group as GroupModel;
...
class InlineEdit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach (array_keys($postItems) as $groupId) {
            /** @var \Magetop\Brand\Model\Group $group */
            $group = $this->_objectManager->create('Magetop\Brand\Model\Group');
    ...
    {
        return $this->_authorization->isAllowed('Magetop_Brand::group_save');
    }
}