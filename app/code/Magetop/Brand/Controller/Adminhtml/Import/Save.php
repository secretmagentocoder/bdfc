...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Magetop\Setup\Helper\Import
     */
    protected $_magetopImport;
    ...
    */
    ...
    public function execute()
    {
        ...
        try {
            ...
            if($uploader) {
                ...
                $savePath     = $tmpDirectory->getAbsolutePath('magetop/import');
                $uploader->setAllowRenameFiles(true);
                $result       = $uploader->save($savePath);
                $filePath = $tmpDirectory->getAbsolutePath('magetop/import/' . $result['file']);
                $fileContent  = file_get_contents($tmpDirectory->getAbsolutePath('magetop/import/' . $result['file']));
            }
        } catch (\Exception $e) {
                            ...
                            if($brand_values && $product_id) {
                                ...
                                foreach($brand_values as $brand_value){
                                    ...
                                    if($brand_value){
                                        ...
                                        $brand_model = $this->_objectManager->create('Magetop\Brand\Model\Brand');
    ...
    {
        return $this->_authorization->isAllowed('Magetop_Brand::import_save');
    }
}
