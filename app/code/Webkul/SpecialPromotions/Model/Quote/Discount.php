 ...
 */
namespace Webkul\SpecialPromotions\Model\Quote;
...
class Discount extends AbstractTotal
{
    ...
    public function collect(
        ...
        foreach ($rules as $rule) {
            if (in_array($rule->getSimpleAction(),$defaultRules)) {
