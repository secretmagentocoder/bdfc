 ...
 */
namespace Webkul\SpecialPromotions\Console\Command;
...
class DisablePromotion extends Command
{
     ...
     * @param \Webkul\SpecialPromotions\Plugin\Model\Rule\Metadata\ValueProvider $valueProvider
     */
    public function __construct(
        ...
        \Webkul\SpecialPromotions\Plugin\Model\Rule\Metadata\ValueProvider $valueProvider
    ) {
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($this->_moduleManager->isEnabled('Webkul_SpecialPromotions')) {
            ...
            $this->_modStatus->setIsEnabled(false, ['Webkul_SpecialPromotions']);
            ...
            $connection->delete(
                $tableName,
                ['module = ?' => 'Webkul_SpecialPromotions']
            );
