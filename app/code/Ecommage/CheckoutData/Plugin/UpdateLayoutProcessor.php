...
class UpdateLayoutProcessor
{
    ...
    public function aroundProcess(\Magento\Checkout\Block\Checkout\LayoutProcessor $subject, callable $next, array $jsLayout)
    {
        $attributesToConvert = [
    ...
    {
        return [
            'component' => 'Ecommage_CheckoutData/js/view/billing-address',
