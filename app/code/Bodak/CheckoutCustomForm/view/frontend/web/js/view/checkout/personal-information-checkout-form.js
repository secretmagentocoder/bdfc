...
define([
    ...
    'Bodak_CheckoutCustomForm/js/model/checkout/personal-information-checkout-form'
    ...
    return Component.extend({
        ...
        initialize: function () {
            var self = this;
            this._super();
            formData = this.source.get('personalInformationCheckoutForm');
            var formDataCached = cartCache.get('custom-form');
            if (formDataCached) {
                formData = this.source.set('personalInformationCheckoutForm', formDataCached);
            }
        ...
        saveCustomFields: function() {
            ...
            this.source.trigger('personalInformationCheckoutForm.data.validate');

            if (!this.source.get('params.invalid')) {
                var formData = this.source.get('personalInformationCheckoutForm');
                ...
                $.ajax({
                    ...
                    function (response) {
                        cartCache.set('personalInformation-form', formData);
                        result = true;
                    }
                ).fail(
                    function (response) {
