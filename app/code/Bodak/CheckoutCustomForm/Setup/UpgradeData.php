...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(
        ...
        // if (version_compare($context->getVersion(), '1.1.4', '<')) {
            $this->upgradeQuoteData();
            $this->upgradeSalesData();
        // }
        $this->setup = $setup->endSetup();
    }

    /**
     * Install quote custom/Departure data
     *
     * @return void
     */
    public function upgradeQuoteData()
    {
    ...
    /**
     * Install sales custom/Departure data
     *
     * @return void
     */
    public function upgradeSalesData()
    {
