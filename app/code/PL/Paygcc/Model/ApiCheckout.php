...
use Dotdigitalgroup\Email\Controller\Adminhtml\Order;
...
class ApiCheckout extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    {
        return $this->urlBuilder->getUrl('paygcc/apicheckout/success', ['_secure' => $this->getRequest()->isSecure()]);
    }
    ...
    public function getPayGCCPaymentUrl(\Magento\Sales\Model\Order $order)
    {
        ...
        $request['success_url'] = $this->getSuccessRedirectUrl();
        $request['failed_url'] = $this->getFailedRedirectUrl();
