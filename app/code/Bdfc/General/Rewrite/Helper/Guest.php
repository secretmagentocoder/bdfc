<?php
/**
 * @package Bdfc_Checkout
 */
declare(strict_types=1);

namespace Bdfc\General\Rewrite\Helper;
...
class Guest extends \Magento\Sales\Helper\Guest
{
    ...
    public function __construct(
        ...
        parent::__construct($context, $storeManager, $coreRegistry, $customerSession, $cookieManager, $cookieMetadataFactory, $messageManager, $orderFactory, $resultRedirectFactory);
    }
    ...
    private function compareStoredBillingDataWithInput(Order $order, array $postData)
    {
        ...
        return strtolower($billingAddress->getLastname()) &&
